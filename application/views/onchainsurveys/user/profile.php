...
<?php //pre($this->session->userdata()); ?>
 ...
 <!-- Masthead-->
        <header class="masthead pages-head">
            <div class="container">
                <div class="masthead-subheading">Profile</div>
							   ...
							   <!--  <div class="form-group row">
							    ...
							    <div class="form-group row mb-3">
									...
									<div class="form-group col-lg-3">
										<input type="submit" value="Save" class="btn btn-outline custom-btn-outline btn-danger rounded-0 text-color-light bg-color-hover-transparent text-color-hover-light font-weight-semibold custom-button-with-arrowbtn float-end" data-loading-text="Loading..." onclick="profile_form(event);">
									</div>
						...
						<div class="col-lg-9 d-none" id="password_update_form_container" >
							...
							<form role="form" id="password_form" class="needs-validation" action="user/resetpassword" novalidate="novalidate">
							    ...
							    <div class="form-group row">
									...
									<div class="form-group col-lg-3">
										<input type="submit" value="Update" class="btn btn-outline custom-btn-outline btn-danger rounded-0 text-color-light bg-color-hover-transparent text-color-hover-light font-weight-semibold custom-button-with-arrowbtn float-end" data-loading-text="Loading..." onclick="password_form(event);">
									</div>
