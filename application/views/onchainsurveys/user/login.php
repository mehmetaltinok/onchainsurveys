	...
	<div class="container">
		<div class="text-center">
			...
			<div class="col-md-6 offset-3">
				...
				<h4 class="text-color-light custom-text-10 font-weight-bold text-center pt-5 mt-5 mb-5">Login</h4>
				...
				<form id="login_form" class="" action="user/login_in/" method="POST"  onsubmit="return false;">  
					...
					<div class="mb-3">
						<div class="form-group d-block  ">
							<input type="text" value="" maxlength="100" class="form-control py-4 px-4 rounded-0   border-1" name="user_name" id="user_name" placeholder="User Name">
					...
					<div class="mb-3">
						<div class="form-group  ">
							<input type="password" value="" maxlength="100" class="form-control py-4 px-4 rounded-0   border-0" name="password" id="password" placeholder="Password" >
					...
					<div class="mb-3">
						<div class="form-group  ">
							<button type="submit" href="javascript::" class="btn btn-outline custom-btn-outline btn-info rounded-0   custom-text-4   px-4 py-3 w-100" onclick="login_form(event);" id="login_btn">Login</button>
						</div>
					</div>
