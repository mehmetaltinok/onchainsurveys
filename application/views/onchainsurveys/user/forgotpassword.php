...
<header class="masthead pages-head">
	<div class="container">
		<div class="masthead-subheading">Reset Password</div>
				...
				<form id="forgotPassword_form" class="contact-form" action="user/recoverPassword" method="POST" novalidate="novalidate" onsubmit="return false;">
					...
					<div class="row justify-content-center mb-3">
						<div class="form-group d-block col-6">
							<input type="text" value="" data-msg-required="Please enter your name." maxlength="100" class="form-control py-2 px-4 rounded-0 text-color-light bg-color-secondary border-0" name="email" id="email" placeholder="Email">
					...
					<div class="row justify-content-center mb-3">
						<div class="form-group col-6">
							<button type="submit" href="demo-digital-agency-2-dark-our-blog.html" class="btn btn-outline custom-btn-outline btn-danger rounded-0 text-color-light custom-text-4 bg-color-hover-transparent text-color-hover-light font-weight-semibold custom-button-with-arrow px-4 py-2 w-100" onclick="forgotPassword_form(event);">Submit</button>
						</div>
					</div>
