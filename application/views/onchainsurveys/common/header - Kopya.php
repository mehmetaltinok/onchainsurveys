...
<html class="dark">
	<head>
		...
		<style>
			/*a.nav-link{ color: #fff !important; padding: 2px; }
			a.nav-link:hover{ text-decoration: none; color: red !important;  }
			.menu_wallet > a.nav-link:hover { color: #fff !important; }
			ul.dropdown-menu.show { background: #454545; }*/
										...
										<div class="header-nav-main header-nav-main-mobile-dark header-nav-main-square header-nav-main-dropdown-no-borders header-nav-main-effect-2 header-nav-main-sub-effect-1">
											...
											<nav class="collapse" id="menu">
												...
												<ul class="nav nav-pills" id="mainNav">
													...
													<li class="dropdown-primary">
														<a class="nav-link text-capitalize font-weight-semibold custom-text-3 " href="<?=base_url("home");?>"  >
															<!-- active -->
															Home
														</a>
													</li>
													...
													<li class="dropdown">
														<a class="nav-link dropdown-toggle text-capitalize font-weight-semibold custom-text-3" class="dropdown-toggle" href="<?=base_url("survey");?>" id="survey">
															Surveys
														</a>
